...
### System requirements
The app has only been tested on computers with Windows 11 and acOS Sequoia 15.3.2 operating systems. It requires Python version 3.11 or higher. Other dependencies can be installed as explained below.
